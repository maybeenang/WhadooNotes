...
import { Octicons, SimpleLineIcons, MaterialCommunityIcons, MaterialIcons, Feather } from "@expo/vector-icons";
...
<View style={styles.optionContainer}>
  ...
  <TouchableOpacity style={styles.innerOptionContainer}>
    <View style={styles.optionDesc}>
      <MaterialCommunityIcons name="lock-outline" size={24} color="#676767" />
...
<View style={styles.optionContainer}>
  ...
  <TouchableOpacity style={styles.innerOptionContainer}>
    ...
    <View>
      <MaterialCommunityIcons name="toggle-switch-off-outline" size={30} color="black" borderWidth="1"/>
    </View>          
  </TouchableOpacity>
</View>
<View style={styles.optionContainer}>
  ...
  <TouchableOpacity style={styles.innerOptionContainer}>
    <View style={styles.optionDesc}>
      <MaterialCommunityIcons name="folder-open-outline" size={24} color="#676767" />
